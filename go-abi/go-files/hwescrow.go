...
//
// Solidity: function getMessageHash(address _recruiter, address _creator, address _paymentToken, uint256 _totalPayment, uint256 _downPayment, uint256 _deadline) pure returns(bytes32)
func (_Hwescrow *HwescrowCaller) GetMessageHash(opts *bind.CallOpts, _recruiter common.Address, _creator common.Address, _paymentToken common.Address, _totalPayment *big.Int, _downPayment *big.Int, _deadline *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Hwescrow.contract.Call(opts, &out, "getMessageHash", _recruiter, _creator, _paymentToken, _totalPayment, _downPayment, _deadline)
...
//
// Solidity: function getMessageHash(address _recruiter, address _creator, address _paymentToken, uint256 _totalPayment, uint256 _downPayment, uint256 _deadline) pure returns(bytes32)
func (_Hwescrow *HwescrowSession) GetMessageHash(_recruiter common.Address, _creator common.Address, _paymentToken common.Address, _totalPayment *big.Int, _downPayment *big.Int, _deadline *big.Int) ([32]byte, error) {
	return _Hwescrow.Contract.GetMessageHash(&_Hwescrow.CallOpts, _recruiter, _creator, _paymentToken, _totalPayment, _downPayment, _deadline)
}

// GetMessageHash is a free data retrieval call binding the contract method 0x2e900195.
//
// Solidity: function getMessageHash(address _recruiter, address _creator, address _paymentToken, uint256 _totalPayment, uint256 _downPayment, uint256 _deadline) pure returns(bytes32)
func (_Hwescrow *HwescrowCallerSession) GetMessageHash(_recruiter common.Address, _creator common.Address, _paymentToken common.Address, _totalPayment *big.Int, _downPayment *big.Int, _deadline *big.Int) ([32]byte, error) {
	return _Hwescrow.Contract.GetMessageHash(&_Hwescrow.CallOpts, _recruiter, _creator, _paymentToken, _totalPayment, _downPayment, _deadline)
}
...
// Hw721 is a free data retrieval call binding the contract method 0x3ece6340.
//
// Solidity: function hw721() view returns(address)
func (_Hwescrow *HwescrowCaller) Hw721(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Hwescrow.contract.Call(opts, &out, "hw721")
...
//
// Solidity: function hw721() view returns(address)
func (_Hwescrow *HwescrowSession) Hw721() (common.Address, error) {
	return _Hwescrow.Contract.Hw721(&_Hwescrow.CallOpts)
}

// Hw721 is a free data retrieval call binding the contract method 0x3ece6340.
//
// Solidity: function hw721() view returns(address)
func (_Hwescrow *HwescrowCallerSession) Hw721() (common.Address, error) {
	return _Hwescrow.Contract.Hw721(&_Hwescrow.CallOpts)
}
