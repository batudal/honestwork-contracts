...
contract HonestPayLock is Ownable, ReentrancyGuard, SigUtils {
    ...
    mapping(uint256 => uint256) public nftGrossRevenue; //keeps track of the gross revenue generated by each nft
    ...
    function unlockPayment(
        ...
        nftGrossRevenue[_recruiterNFT] += grossRev;
    ...
    function claimPayment(
        ...
        nftGrossRevenue[_creatorNFT] += grossRev;
