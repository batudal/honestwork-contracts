...
// DealsAll is a free data retrieval call binding the contract method 0xd34c5c18.
//
// Solidity: function dealsAll(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowCaller) DealsAll(opts *bind.CallOpts, arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
	...
	var out []interface{}
	err := _Hwescrow.contract.Call(opts, &out, "dealsAll", arg0)
...
//
// Solidity: function dealsAll(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowSession) DealsAll(arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
	...
	return _Hwescrow.Contract.DealsAll(&_Hwescrow.CallOpts, arg0)
}

// DealsAll is a free data retrieval call binding the contract method 0xd34c5c18.
//
// Solidity: function dealsAll(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowCallerSession) DealsAll(arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
...
// DealsMap is a free data retrieval call binding the contract method 0x8d0369c6.
//
// Solidity: function dealsMap(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowCaller) DealsMap(opts *bind.CallOpts, arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
	...
	var out []interface{}
	err := _Hwescrow.contract.Call(opts, &out, "dealsMap", arg0)
...
//
// Solidity: function dealsMap(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowSession) DealsMap(arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
	...
	return _Hwescrow.Contract.DealsMap(&_Hwescrow.CallOpts, arg0)
}

// DealsMap is a free data retrieval call binding the contract method 0x8d0369c6.
//
// Solidity: function dealsMap(uint256 ) view returns(address recruiter, address creator, address paymentToken, uint256 totalPayment, uint256 hwProfit, uint256 claimedAmount, uint256 claimableAmount, uint256 jobId, uint8 status)
func (_Hwescrow *HwescrowCallerSession) DealsMap(arg0 *big.Int) (struct {
	Recruiter       common.Address
	Creator         common.Address
	PaymentToken    common.Address
	TotalPayment    *big.Int
